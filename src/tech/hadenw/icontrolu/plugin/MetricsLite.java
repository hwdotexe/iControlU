...
public class MetricsLite {
     ...
     */
    public MetricsLite(iControlU plugin) {
        if (plugin == null) {
        ...
        // Get the config file
        File bStatsFolder = new File(plugin.getDataFolder().getParentFile(), "iControlU");
        File configFile = new File(bStatsFolder, "bStats.yml");
